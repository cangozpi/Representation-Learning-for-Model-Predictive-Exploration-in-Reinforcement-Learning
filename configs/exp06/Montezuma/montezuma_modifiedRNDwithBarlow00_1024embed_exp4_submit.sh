...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRNDwithBarlow00_1024embed_exp4_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp06/Montezuma/config_modifiedRNDwithBarlow00_1024embed.conf --log_name=montezuma_modifiedRNDwithBarlow00_1024embed_exp4 --save_model_path=checkpoints/exp06/Montezuma/montezuma_modifiedRNDwithBarlow00_1024embed_exp4.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
