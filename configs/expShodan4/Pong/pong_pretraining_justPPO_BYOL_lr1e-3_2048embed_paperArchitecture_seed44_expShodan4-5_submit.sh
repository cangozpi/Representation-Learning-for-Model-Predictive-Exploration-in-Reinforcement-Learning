#!/bin/bash 
# --job-name=Pong_pretraining_justPPO_BYOL_lr1e-3_2048embed_paperArchitecture_seed44_expShodan4-5_7day_batchjob
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=45 main.py --train --num_env_per_process 64 --config_path=./configs/expShodan4/Pong/config_justPPO_BYOL_lr1e-3_2048embed_paperArchitecture_Pong.conf --log_name=pong_pretraining_justPPO_BYOL_lr1e-3_2048embed_paperArchitecture_seed44_expShodan4-5 --save_model_path=checkpoints/expShodan4/Pong/pong_pretraining_justPPO_BYOL_lr1e-3_2048embed_paperArchitecture_expShodan4-5.ckpt --seed=44 --gpu_id=0 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
