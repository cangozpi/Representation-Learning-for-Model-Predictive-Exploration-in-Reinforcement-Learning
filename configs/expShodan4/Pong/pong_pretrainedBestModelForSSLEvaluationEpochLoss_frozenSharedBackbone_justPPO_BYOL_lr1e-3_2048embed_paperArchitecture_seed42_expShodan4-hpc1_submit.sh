...
# -= Resources =-
#
#SBATCH --job-name=Pong_pretrainedBestModelForSSLEvaluationEpochLoss_frozenSharedBackbone_justPPO_BYOL_1e-3_2048embed_paperArchitecture_seed42_expShodan4-hpc1_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=411 main.py --train --num_env_per_process 64 --config_path=./configs/expShodan4/Pong/config_pretrained_frozenSharedBackbone_justPPO_BYOL_lr1e-3_2048embed_paperArchitecture_Pong.conf --log_name=pong_pretrainedBestModelForSSLEvaluationEpochLoss_justPPO_BYOL_1e-3_2048embed_paperArchitecture_seed42_expShodan4-hpc1 --save_model_path=checkpoints/expShodan4/Pong/pong_pretrainedBestModelForSSLEvaluationEpochLoss_justPPO_BYOL_1e-3_2048embed_paperArchitecture_expShodan4-hpc1.ckpt --load_model_path=checkpoints/expShodan4/Pong/pong_pretraining_justPPO_BYOL_lr1e-3_2048embed_paperArchitecture_expShodan4-5__BestModelForSSLEvaluationEpochLoss.ckpt --seed=42 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
