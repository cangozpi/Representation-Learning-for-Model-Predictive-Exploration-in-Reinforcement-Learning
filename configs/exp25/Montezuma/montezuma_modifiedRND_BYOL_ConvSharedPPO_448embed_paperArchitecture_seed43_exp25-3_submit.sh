...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_BYOL_ConvSharedPPO_448embed_paperArchitecture_seed43_exp25-3_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=253 main.py --train --num_env_per_process 64 --config_path=./configs/exp25/Montezuma/config_modifiedRND_BYOL_ConvSharedPPO_448embed_paperArchitecture_Montezuma.conf --log_name=montezuma_modifiedRND_BYOL_ConvSharedPPO_448embed_paperArchitecture_seed43_exp25-3 --save_model_path=checkpoints/exp25/Montezuma/montezuma_modifiedRND_BYOL_ConvSharedPPO_448embed_paperArchitecture_exp25-3.ckpt --seed=43 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
