...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_BYOL_2048embed_EMA_tau005_paperArchitecture_seed42_exp28-2_7day_batchjob
#SBATCH --nodes=1
