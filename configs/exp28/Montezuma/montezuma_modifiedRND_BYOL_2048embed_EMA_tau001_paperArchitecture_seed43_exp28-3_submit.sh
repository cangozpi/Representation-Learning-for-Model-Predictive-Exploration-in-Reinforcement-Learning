...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_BYOL_2048embed_EMA_tau001_paperArchitecture_seed43_exp28-3_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp28/Montezuma/config_modifiedRND_BYOL_2048embed_EMA_tau001_paperArchitecture_Montezuma.conf --log_name=montezuma_modifiedRND_BYOL_2048embed_EMA_tau001_paperArchitecture_seed43_exp28-3 --save_model_path=checkpoints/exp28/Montezuma/montezuma_modifiedRND_BYOL_2048embed_EMA_tau001_paperArchitecture_exp28-3.ckpt --seed=43 --use_wandb --wandb_api_key=c44854fd20c3fd3003a1c5b49426093698ada7b1
