...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_justPPO_noSSL_2048embed_paperArchitecture_seed44_exp21-13_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp21/Montezuma/config_justPPO_noSSL_2048embed_paperArchitecture_Montezuma.conf --log_name=montezuma_justPPO_noSSL_2048embed_paperArchitecture_seed44_exp21-13 --save_model_path=checkpoints/exp21/Montezuma/montezuma_justPPO_noSSL_2048embed_paperArchitecture_exp21-13.ckpt --seed=44 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
