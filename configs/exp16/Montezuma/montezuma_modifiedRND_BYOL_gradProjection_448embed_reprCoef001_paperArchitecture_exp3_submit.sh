...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_BYOL_gradProjection_448embed_reprCoef001_paperArchitecture_exp3_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp16/Montezuma/config_modifiedRND_BYOL_gradProjection_448embed_reprCoef001_paperArchitecture_Montezuma.conf --log_name=montezuma_modifiedRND_BYOL_gradProjection_448embed_reprCoef001_paperArchitecture_exp3 --save_model_path=checkpoints/exp16/Montezuma/montezuma_modifiedRND_BYOL_gradProjection_448embed_reprCoef001_paperArchitecture_exp3.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
