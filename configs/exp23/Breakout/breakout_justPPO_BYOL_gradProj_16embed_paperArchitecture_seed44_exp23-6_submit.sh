...
# -= Resources =-
#
#SBATCH --job-name=Breakout_justPPO_BYOL_gradProj_16embed_paperArchitecture_seed44_exp23-6_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=236 main.py --train --num_env_per_process 64 --config_path=./configs/exp23/Breakout/config_justPPO_BYOL_gradProj_16embed_paperArchitecture_Breakout.conf --log_name=breakout_justPPO_BYOL_gradProj_16embed_paperArchitecture_seed44_exp23-6 --save_model_path=checkpoints/exp23/Breakout/breakout_justPPO_BYOL_gradProj_16embed_paperArchitecture_exp23-6.ckpt --seed=44 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
