...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_justPPO_noSSL_448embed_paperArchitecture_exp2_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp11/Montezuma/config_justPPO_noSSL_448embed_paperArchitecture.conf --log_name=montezuma_justPPO_noSSL_448embed_paperArchitecture_exp2 --save_model_path=checkpoints/exp11/Montezuma/montezuma_justPPO_noSSL_448embed_paperArchitecture_exp2.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
