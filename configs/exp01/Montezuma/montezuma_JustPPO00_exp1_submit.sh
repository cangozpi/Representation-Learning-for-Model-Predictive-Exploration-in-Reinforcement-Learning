...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_JustPPO00_exp1_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp01/Montezuma/config_JustPPO00.conf --log_name=montezuma_JustPPO00_exp1 --save_model_path=checkpoints/exp01/Montezuma/montezuma_JustPPO00_exp1.ckpt
