...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND00_intCoef1_exp3_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp01/Montezuma/config_modifiedRND00_intCoef1.conf --log_name=montezuma_modifiedRND00_intCoef1_exp3 --save_model_path=checkpoints/exp01/Montezuma/montezuma_modifiedRND00_intCoef1_exp3.ckpt
