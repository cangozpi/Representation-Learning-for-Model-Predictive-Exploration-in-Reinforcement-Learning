...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_pretrainedBestModelForSSLEvaluationEpochLoss_RLandSSLtrainedSharedBackbone_modifiedRND_BYOL_1e-3_2048embed_paperArchitecture_seed44_expShodan3extension-hpc7_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=313 main.py --train --num_env_per_process 64 --config_path=./configs/expShodan3extension/Montezuma/config_pretrained_RLandSSLtrainedSharedBackbone_modifiedRND_BYOL_lr1e-3_2048embed_paperArchitecture_Montezuma.conf --log_name=montezuma_pretrainedBestModelForSSLEvaluationEpochLoss_RLandSSLtrainedSharedBackbone_modifiedRND_BYOL_1e-3_2048embed_paperArchitecture_seed44_expShodan3extension-hpc7 --save_model_path=checkpoints/expShodan3extension/Montezuma/montezuma_pretrainedBestModelForSSLEvaluationEpochLoss_RLandSSLtrainedSharedBackbone_modifiedRND_BYOL_1e-3_2048embed_paperArchitecture_expShodan3extension-hpc7.ckpt --load_model_path=checkpoints/expShodan3/Montezuma/montezuma_pretraining_modifiedRND_BYOL_lr1e-3_2048embed_paperArchitecture_expShodan3-5__BestModelForSSLEvaluationEpochLoss.ckpt --seed=44 --use_wandb --wandb_api_key=c44854fd20c3fd3003a1c5b49426093698ada7b1
