...
# -= Resources =-
#
#SBATCH --job-name=Pong_justPPO_BYOL_gradProj_2048embed_paperArchitecture_seed42_exp22-1_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=221 main.py --train --num_env_per_process 64 --config_path=./configs/exp22/Pong/config_justPPO_BYOL_gradProj_2048embed_paperArchitecture_Pong.conf --log_name=pong_justPPO_BYOL_gradProj_2048embed_paperArchitecture_seed42_exp22-1 --save_model_path=checkpoints/exp22/Pong/pong_justPPO_BYOL_gradProj_2048embed_paperArchitecture_exp22-1.ckpt --seed=42 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
