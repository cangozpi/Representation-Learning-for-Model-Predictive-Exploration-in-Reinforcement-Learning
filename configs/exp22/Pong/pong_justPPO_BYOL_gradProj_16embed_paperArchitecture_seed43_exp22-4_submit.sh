...
# -= Resources =-
#
#SBATCH --job-name=Pong_justPPO_BYOL_gradProj_16embed_paperArchitecture_seed43_exp22-4_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=224 main.py --train --num_env_per_process 64 --config_path=./configs/exp22/Pong/config_justPPO_BYOL_gradProj_16embed_paperArchitecture_Pong.conf --log_name=pong_justPPO_BYOL_gradProj_16embed_paperArchitecture_seed43_exp22-4 --save_model_path=checkpoints/exp22/Pong/pong_justPPO_BYOL_gradProj_16embed_paperArchitecture_exp22-4.ckpt --seed=43 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
