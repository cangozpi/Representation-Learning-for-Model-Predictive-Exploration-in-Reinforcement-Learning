...
torchrun --nnodes 1 --nproc_per_node 129 --standalone main.py --train --config_path=./configs/exp00/Montezuma/config_justPPOandBarlow00.conf --log_name=montezuma_justPPOandBarlow00_exp6 --save_model_path=checkpoints/Montezuma/montezuma_justPPOandBarlow00_exp6.ckpt
