...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_justPPOandBarlow00_exp6_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 128 --config_path=./configs/exp00/Montezuma/config_justPPOandBarlow00.conf --log_name=montezuma_justPPOandBarlow00_exp6 --save_model_path=checkpoints/Montezuma/montezuma_justPPOandBarlow00_exp6.ckpt
