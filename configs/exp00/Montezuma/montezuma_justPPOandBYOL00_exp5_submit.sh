...
torchrun --nnodes 1 --nproc_per_node 129 --standalone main.py --train --config_path=./configs/exp00/Montezuma/config_justPPOandBYOL00.conf --log_name=montezuma_justPPOandBYOL00_exp5 --save_model_path=checkpoints/Montezuma/montezuma_justPPOandBYOL00_exp5.ckpt
