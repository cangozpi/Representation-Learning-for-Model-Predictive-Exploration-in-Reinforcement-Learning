...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_Barlow_2048embed_reprCoef0001_paperArchitecture_seed42_exp26-2_7day_batchjob
#SBATCH --nodes=1
