...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_Barlow_2048embed_reprCoef10_paperArchitecture_seed42_exp26-1_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp26/Montezuma/config_modifiedRND_Barlow_2048embed_reprCoef10_paperArchitecture_Montezuma.conf --log_name=montezuma_modifiedRND_Barlow_2048embed_reprCoef10_paperArchitecture_seed42_exp26-1 --save_model_path=checkpoints/exp26/Montezuma/montezuma_modifiedRND_Barlow_2048embed_reprCoef10_paperArchitecture_exp26-1.ckpt --seed=42 --use_wandb --wandb_api_key=c44854fd20c3fd3003a1c5b49426093698ada7b1
