...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND00_intCoef1000_1024embed_exp5_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp02/Montezuma/config_modifiedRND00_intCoef1000.conf --log_name=montezuma_modifiedRND00_intCoef1000_1024embed_exp5 --save_model_path=checkpoints/exp02/Montezuma/montezuma_modifiedRND00_intCoef1000_1024embed_exp5.ckpt
