...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_originalRND00_intCoef100_exp2_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp02/Montezuma/config_originalRND00_intCoef100.conf --log_name=montezuma_originalRND00_intCoef100_exp2 --save_model_path=checkpoints/exp02/Montezuma/montezuma_originalRND00_intCoef100_exp2.ckpt
