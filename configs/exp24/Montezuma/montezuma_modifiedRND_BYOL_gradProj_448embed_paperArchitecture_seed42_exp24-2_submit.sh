...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND_BYOL_gradProj_448embed_paperArchitecture_seed42_exp24-2_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=242 main.py --train --num_env_per_process 64 --config_path=./configs/exp24/Montezuma/config_modifiedRND_BYOL_gradProj_448embed_paperArchitecture_Montezuma.conf --log_name=montezuma_modifiedRND_BYOL_gradProj_448embed_paperArchitecture_seed42_exp24-2 --save_model_path=checkpoints/exp24/Montezuma/montezuma_modifiedRND_BYOL_gradProj_448embed_paperArchitecture_exp24-2.ckpt --seed=42 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
