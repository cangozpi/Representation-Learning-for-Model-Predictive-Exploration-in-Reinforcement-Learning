...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_PPOwithBYOL00_256embed_representationCoef10_exp3_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp07/Montezuma/config_PPOwithBYOL00_256embed_representationCoef10.conf --log_name=montezuma_PPOwithBYOL00_256embed_representatoinCoef10_exp3 --save_model_path=checkpoints/exp07/Montezuma/montezuma_PPOwithBYOL00_256embed_representationCoef10_exp3.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
