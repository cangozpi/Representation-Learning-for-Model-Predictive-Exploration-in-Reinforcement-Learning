...
# -= Resources =-
#
#SBATCH --job-name=Pong_justPPO_BYOL_16embed_reprCoef001_paperArchitecture_seed44_exp19-10_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp19/Pong/config_justPPO_BYOL_16embed_reprCoef001_paperArchitecture_Pong.conf --log_name=pong_justPPO_BYOL_16embed_reprCoef001_paperArchitecture_seed44_exp19-10 --save_model_path=checkpoints/exp19/Pong/pong_justPPO_BYOL_16embed_reprCoef001_paperArchitecture_seed44_exp19-10.ckpt --seed=44 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
