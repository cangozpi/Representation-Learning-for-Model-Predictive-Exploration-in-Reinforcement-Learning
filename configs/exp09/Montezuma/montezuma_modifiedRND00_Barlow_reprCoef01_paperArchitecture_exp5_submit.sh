...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRND00_Barlow_reprCoef01_paperArchitecture_exp5_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp09/Montezuma/config_modifiedRND00_Barlow_reprCoef01_paperArchitecture.conf --log_name=montezuma_modifiedRND00_Barlow_reprCoef01_paperArchitecture_exp5 --save_model_path=checkpoints/exp09/Montezuma/montezuma_modifiedRND00_Barlow_reprCoef01_paperArchitecture_exp5.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
