...
# -= Resources =-
#
#SBATCH --job-name=Pong_justPPO_BYOL_128embed_reprCoef001_paperArchitecture_exp2_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp15/Pong/config_justPPO_BYOL_128embed_reprCoef001_paperArchitecture_Pong.conf --log_name=pong_justPPO_BYOL_128embed_reprCoef001_paperArchitecture_exp2 --save_model_path=checkpoints/exp15/Pong/pong_justPPO_BYOL_128embed_reprCoef001_paperArchitecture_exp2.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8
