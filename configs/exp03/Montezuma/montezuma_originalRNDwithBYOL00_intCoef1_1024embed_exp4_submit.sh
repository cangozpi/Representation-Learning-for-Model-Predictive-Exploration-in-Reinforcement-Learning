...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_originalRNDwithBYOL00_intCoef1_1024embed_exp4_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp03/Montezuma/config_originalRNDwithBYOL00_intCoef1.conf --log_name=montezuma_originalRNDwithBYOL00_intCoef1_1024embed_exp4 --save_model_path=checkpoints/exp03/Montezuma/montezuma_originalRNDwithBYOL00_intCoef1_1024embed_exp4.ckpt
