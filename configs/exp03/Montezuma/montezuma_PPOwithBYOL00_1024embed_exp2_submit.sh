...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_PPOwithBYOL00_1024embed_exp2_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp03/Montezuma/config_PPOwithBYOL00.conf --log_name=montezuma_PPOwithBYOL00_1024embed_exp2 --save_model_path=checkpoints/exp03/Montezuma/montezuma_PPOwithBYOL00_1024embed_exp2.ckpt
