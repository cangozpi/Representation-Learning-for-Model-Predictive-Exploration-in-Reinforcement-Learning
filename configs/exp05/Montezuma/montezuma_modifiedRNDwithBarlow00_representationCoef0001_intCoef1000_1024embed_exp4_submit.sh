...
# -= Resources =-
#
#SBATCH --job-name=Montezuma_modifiedRNDwithBarlow00_representationCoef0001_intCoef1000_1024embed_exp4_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp05/Montezuma/config_modifiedRNDwithBarlow00_representationCoef0001_intCoef1000.conf --log_name=montezuma_modifiedRNDwithBarlow00_representationCoef0001_intCoef1000_1024embed_exp4 --save_model_path=checkpoints/exp05/Montezuma/montezuma_modifiedRNDwithBarlow00_representationCoef0001_intCoef1000_1024embed_exp4.ckpt
