...
def get_args():
    ...
    parser.add_argument("--load_model_path", type=str, default='./models', help="if \'load_model\' is set to True in the config file, then the corresponding model (agent) will be loaded from the directory specified by the value of this argument.")
    parser.add_argument("--save_model_path", type=str, default='./models', help="Trained model (agent) will be saved to the directory that this argument specifies.")
